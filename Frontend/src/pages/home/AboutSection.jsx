    ...
    <div className='overflow-hidden flex md:flex-row flex-col justify-between items-center sm:my-20 my-4 md:gap-12 px-5 lg:px-10 h-75'>
        ...
        <div className='text-start sm:w-1/2'>
          ...
          <p className='text-xl mt-4 text-[#5c5c5c]'>
             Lorem, ipsum. adipisicing elit. Saepe quos omnis sed enim dicta eaque nostrum nisi officia quidem molestiae.
            <br/><br/>
            Lorem  sit  adipisicing elit. Culpa distinctio aliquid eaque laudantium eius, minima quibusdam maiores est aspernatur dignissimos!
          </p>
